...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/23 23:02:49 by mbriand           #+#    #+#             */
/*   Updated: 2024/04/23 23:43:46 by mbriand          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_iv_map_closed_side(char *full_text)
{
	int	i;
...
static void	ft_iv_map_closed_down(char *full_text)
{
	char	*save_full_text;
	int		number_new_line;
...
static void	ft_iv_map_closed_up(char *full_text)
{
	char	*save_full_text;
...
{
	ft_iv_map_closed_up(full_text);
	ft_iv_map_closed_down(full_text);
	ft_iv_map_closed_side(full_text);
}
